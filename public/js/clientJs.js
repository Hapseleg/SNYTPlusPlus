    ...
    $.ajax("/search" + searchText,
        {
            ...
            success : function(documents) {
                ...
                for(var i in documents) {
                    ...
                    var read = "";
                    var category = documents[i].category;
                    ...
                    table.append("<tr class='clickableRow' data-href=" + documents[i]._id + "><td>" + subject + "</td><td>" + category + "</td><td>" + date + "</td><td>" + initials + "</td><td>" + read + "</td></tr>");
                }
